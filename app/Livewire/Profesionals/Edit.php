...
class Edit extends Component
{
    public $fields = [
        ...
        [
            ...
            'creable' => true,
            'create_model' => \App\Models\Especialidad::class,
            'create_fields' => [
                ['name' => 'nombre', 'label' => 'Nombre', 'type' => 'text', 'rules' => 'required'],
                ['name' => 'descripcion', 'label' => 'Descripción', 'type' => 'textarea', 'rules' => 'nullable|string'],
            ],
        ],
        [
            'name' => 'cif',
