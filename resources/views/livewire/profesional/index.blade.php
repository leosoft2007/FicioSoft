<section class="w-full">
    <x-page-header title="Gestión de Profesionales" subtitle="Listado completo de profesionales registrados"
        color="blue">
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                <div
                    ...
                    <div>
                        <flux:button variant="primary" :href="route('profesionals.create')"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">
                                        <div class="flex flex-col items-center justify-center py-8">
                                            ...
                                            <p class="mt-2 font-medium text-gray-700">No se encontraron profesionales
                                            </p>
                ...
                <div class="block md:hidden space-y-4">
                        ...
                        <div class="bg-white shadow rounded-lg p-4 flex flex-row items-start justify-between gap-2">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <span class="font-bold">{{ $profesional->nombre }}
                                        {{ $profesional->apellido }}</span>
                                </div>
                                <div class="text-xs text-gray-500 mb-1">
                                    <div><strong>Especialidad:</strong>
                                        {{ $profesional->especialidad->nombre ?? 'N/A' }}</div>
                                    <div><strong>CIF:</strong> {{ $profesional->cif }}</div>
                                </div>
                                <div class="text-xs text-gray-500">
                                    <div><strong>Teléfono:</strong> {{ $profesional->telefono }}</div>
                                    <div><strong>Email:</strong> {{ $profesional->email ?? 'N/A' }}</div>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="text-center text-gray-500">No se encontraron profesionales</div>
                    @endforelse
                    <div class="mt-4">
                        {{ $profesionals->withQueryString()->links() }}
                    </div>
