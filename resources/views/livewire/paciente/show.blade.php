<!-- filepath: resources/views/livewire/paciente/show.blade.php -->
    ...
    <div x-data="{ activeTab: 'datos' }" class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="p-4 sm:p-6">
            ...
            <div x-show="activeTab === 'datos'" x-transition>
                ...
                <div class="bg-gray-50 px-4 py-4 border-b flex flex-col sm:flex-row items-center gap-4 rounded-t-xl">
                    @if ($paciente->foto)
                ...
                <!-- Tarjetas de información, una por bloque, apiladas en móvil -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4">
                    <!-- Información personal -->
                    <div class="bg-white rounded-lg shadow-sm p-4 space-y-3 border">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $paciente->tipo_documento }}: {{ $paciente->numero_documento }}</dd>
                        </div>
                        <div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 space-y-3 border">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $paciente->medicamentos ?: 'Ninguno registrado' }}</dd>
                        </div>
                        <div>
                            <dt class="text-xs font-medium text-gray-500 uppercase">Historial Médico</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $paciente->historial_medico ?: 'No especificado' }}</dd>
                        </div>
                        <div>
