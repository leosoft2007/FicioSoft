<section class="w-full">
    <x-page-header title="Gestión de Pacientes" subtitle="Listado completo de pacientes registrados" color="green">
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                <div
                    ...
                    <div>
                        <flux:button variant="primary" :href="route('pacientes.create')"
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:text-green-600"
                                ...
                                <tr wire:key="{{ $paciente->id }}" class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <flux:button size="sm" href=""
                                                class="flex items-center gap-1">
                                                <svg class="h-4 w-4" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M9 17v-6h13M5 12H3m6 0a9 9 0 1118 0 9 9 0 01-18 0z" />
                                                </svg>
                                                Ver Cupo
                                            </flux:button>
                                            ...
                                            <flux:button variant="danger" size="sm" variant="danger"
...
<div class="block md:hidden space-y-4">
    @forelse ($pacientes as $paciente)
        <div class="bg-white shadow rounded-lg p-4 flex flex-row items-start justify-between gap-2">
            <div class="flex-1">
                <div>
                    <span class="font-bold">{{ $paciente->nombre }} {{ $paciente->apellido }}</span>
                    <span
            ...
            <div class="flex flex-col gap-1 items-end">
                <flux:button size="sm" wire:navigate href="{{ route('pacientes.show', $paciente->id) }}">
                ...
                <flux:button size="sm" variant="primary" wire:navigate href="{{ route('pacientes.edit', $paciente->id) }}">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                </flux:button>
                <flux:button size="sm" variant="filled" href="{{ route('disponibilidad', $paciente->id) }}">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
    ...
    @empty
        <div class="text-center text-gray-500">No se encontraron pacientes</div>
    @endforelse
    <div class="mt-4">
        {{ $pacientes->withQueryString()->links() }}
    </div>
