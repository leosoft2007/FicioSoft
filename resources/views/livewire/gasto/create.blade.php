<section class="w-full bg-gradient-to-b from-purple-50 to-white">
    <x-page-header title="Gestión de Gastos" subtitle="Crear gasto" color="purple">
            ...
            <div class="p-6 bg-white shadow-lg rounded-xl border border-purple-100">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800">Crear Gasto</h3>
                    </div>
                ...
                <div class="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 rounded-lg shadow-inner">
                    <form method="POST" wire:submit.prevent="save" role="form" enctype="multipart/form-data">
                        @csrf
